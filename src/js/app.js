App = {
  ...
  initContract: function() {
	...
	},
	{
	  ...
	  App.contracts.Land =  web3.eth.contract(abi).at('0x74866EFf1bA9396D3B4E382799C8cB7222a49F83');
...
bindEvents: function() {
  ...
  approveProperty: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
		...
		App.contracts.Land.approveProperty(PropId, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
  ...
  rejectProperty: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                        ...
                        App.contracts.Land.rejectProperty(PropId, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
  ...
  reqchangeOwnership: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                        ...
                        App.contracts.Land.changeOwnership(PropId, NewOwner, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
  ...
  approveChangeOwnership: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                        ...
                        App.contracts.Land.approveChangeOwnership(PropId, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
  ...
  changeValue: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                        ...
                        App.contracts.Land.changeValue(PropId, NewVal, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
  ...
  //  event.preventDefault();
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                                            ...
                                            App.contracts.Land.getPropertyDetails(PropId, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                                              if(!error)
                                          {        console.log(JSON.stringify(result));
                                          ...
                                          App.contracts.Land.propOwnerChange(PropId, function(error, result){
                                            if(!error)
                                            {
  ...
  adduser: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                        ...
                        {App.contracts.Land.addNewUser(useraddress, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(result);
                          else
                              console.error(error);
                        ...
                        {App.contracts.Land.addNewAdmin(useraddress, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
                        ...
                        {App.contracts.Land.addNewSuperAdmin(useraddress, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
  ...
  approveUsers: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
		...
		App.contracts.Land.approveUsers(useraddress, {gas: 1000000, gasPrice: web3.toWei(20, 'gwei')}, function(error, result){
                          if(!error)
                              console.log(JSON.stringify(result));
                          else
                              console.error(error);
